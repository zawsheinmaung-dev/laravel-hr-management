...
let parent_dep_name=ref("");


defineOptions({
    name: "DepermentCreate",
    layout: Layout,
});
...
function deparment_create()
{
    form.post(route('deparments.store'),{
        onSuccess:(succ)=>{
            form.reset();
        }
    })
...
function select_parent_dep(dep)
{
    ...
    form.parent_department_id =dep.id
    form.head_employee_id=dep.head_emp?.id ?? null
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                <button
                    ...
                    @click.prevent="deparment_create"
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="relative">
                        ...
                        >
                            <div
                                v-for="parent_dep in deparments" :key="parent_dep.id"
                        ...
                        <!-- No Result -->
                        <div
                            v-if="show_parent_dep && deparments.length ==0"
                    ...
                    <!-- Department Manager -->
                    <Search v-model="form.head_employee_id"/>
                </div>
            </div>
