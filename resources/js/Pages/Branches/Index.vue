    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 justify-between">
            ...
            >
                ...
                <option v-for="branche in branch" :key="branche.id">
                    {{ branche.name }}
                </option>
            </select>
            <div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-5 py-3">
                            {{ branche.employees.length }}
                        </td>

                        <td class="px-5 py-3">
                            <div class="flex gap-1">
                                <Link
                                    :href="route('branches.show', branche.id)"
                                ...
                                <Link
                                    :href="route('branches.edit', branche.id)"
                                    class="px-2 py-1 rounded-lg bg-blue-100 hover:bg-blue-200"
                                >
                                    Edit
                                </Link>
                                <button
                                @click.prevent="branch_delete(branche.id)"
